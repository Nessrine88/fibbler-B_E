...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    doc: Schema.Attribute.Relation<'oneToOne', 'api::doc.doc'>;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    quickLinks: Schema.Attribute.Component<'text.link', true>;
    section1: Schema.Attribute.RichText;
    section2: Schema.Attribute.RichText;
    section3_part1: Schema.Attribute.RichText;
    section3_part2: Schema.Attribute.RichText;
    section4: Schema.Attribute.RichText;
    section5: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDocDoc extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    articles: Schema.Attribute.Component<'articles.article', false>;
